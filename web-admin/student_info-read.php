    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <p>
                    <?php
                    echo "<a href='student_info-update.php?id=". $row['id'] ."' title='Edit Details' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a>";
                    ?>
                    <a href='#' class="btn btn-primary">Click icon to edit</a>
                    <a href="student_info.php" class="btn btn-default">Back</a> <br/><br/><br/><br/><br/><br/>
                </p>
            </div>
        </div>
    </div>
